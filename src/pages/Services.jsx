...
import tempHeroImage from "../assets/images/temp-services-image.jpg";
import SeeMore from "../components/SeeMore";

/**
 * Condensed services component for home page
 */
export const ServicesCondensed = () => {
  ...
  return (
    <section id="services" ref={ref}>
      ...
      >
        ...
        <motion.h1 className="text-ghost" variants={textVariants}>Services</motion.h1>
